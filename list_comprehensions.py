...
# named fruits_with_more_than_two_vowels. Hint: You'll need a way to check if
...
print([number for number in numbers if len(str(number)) > 1])
...
print([number for number in numbers if number < 0 and number % 2 == 1])
...
print([number for number in numbers if isprime(number)])
